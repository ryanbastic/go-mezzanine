...
type ApiQueryIndexRequest struct {
	ctx context.Context
...
func (r ApiQueryIndexRequest) Execute() ([]IndexEntryResponse, *http.Response, error) {
	return r.ApiService.QueryIndexExecute(r)
}

/*
QueryIndex Query secondary index
...
func (a *IndexAPIService) QueryIndexExecute(r ApiQueryIndexRequest) ([]IndexEntryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []IndexEntryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IndexAPIService.QueryIndex")
	if err != nil {
